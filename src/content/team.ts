...
export const team: TeamContent = {
  ...
  members: [
    ...
    },
    {
      ...
      highlights: [
        "2026 California State Finalist (7th place)",
        "2026 NSDA Nationals Semifinalist",
        "LA County/Regional Champion",
        "National Online Forensics Champion",
        "2x La Costa Finalist and TOC Bidder",
      ],
